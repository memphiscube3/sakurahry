...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Kasino Sakura — Sociální kasino zdarma" },
      { name: "description", content: "Hrajte zdarma japonský slot Kasino Sakura. Bez vkladů, bez výher reálných peněz — jen zábava a virtuální mince." },
      { name: "author", content: "Kasino Sakura" },
      { property: "og:title", content: "Kasino Sakura — Sociální kasino zdarma" },
      { property: "og:description", content: "Hrajte zdarma japonský slot Kasino Sakura. Bez vkladů, bez výher reálných peněz — jen zábava a virtuální mince." },
    ...
    links: [
      ...
      { rel: "stylesheet", href: "https://fonts.googleapis.com/css2?family=Yuji+Mai&family=Noto+Serif+JP:wght@400;500;700;900&family=Cinzel+Decorative:wght@700;900&family=Cinzel:wght@400;500;700&display=swap" },
    ],
  }),
